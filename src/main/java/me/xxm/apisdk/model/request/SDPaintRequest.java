...
import me.xxm.apisdk.model.params.SDPaintParams;
...
public class SDPaintRequest extends BaseRequest<SDPaintParams, ResultResponse> {
    @Override
    ...
    public String getPath() {
        return GetPathEnum.SD_PAINT.getValue();
    }
