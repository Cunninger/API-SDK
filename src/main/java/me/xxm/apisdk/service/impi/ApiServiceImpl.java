package me.xxm.apisdk.service.impi;
...
import me.xxm.apisdk.exception.ErrorResponse;
import me.xxm.apisdk.exception.ResponseCode;
...
import me.xxm.apisdk.util.SignUtil;
import lombok.Data;
...
public class ApiServiceImpl implements ApiService {
    ...
    @Override
    public ResultResponse getAiChat(AiChatRequest request) throws BusinessException {
        return request(request);
    }

    @Override
    public ResultResponse getAiChat(ApiClient apiClient, AiChatRequest request) throws BusinessException {
        return request(apiClient, request);
    }

    @Override
    public ResultResponse getAiSearch(AiSearchRequest request) throws BusinessException {
        return request(request);
    }

    @Override
    public ResultResponse getAiSearch(ApiClient apiClient, AiSearchRequest request) throws BusinessException {
        return request(apiClient, request);
    }

    @Override
    public ResultResponse getStableDiffusion(SDPaintRequest request) throws BusinessException {
        return request(request);
    }

    @Override
    public ResultResponse getStableDiffusion(ApiClient apiClient, SDPaintRequest request) throws BusinessException {
        return request(apiClient, request);
    }

    @Override
    public ResultResponse getCountDown(CountDownRequest request) throws BusinessException {
        return request(request);
    }

    @Override
    public ResultResponse getCountDown(ApiClient apiClient, CountDownRequest request) throws BusinessException {
        return request(apiClient, request);
    }

    @Override
    public ResultResponse getMaoYanMovieTop(CountDownRequest request) throws BusinessException {
        return request(request);
    }

    @Override
    public ResultResponse getMaoYanMovieTop(ApiClient apiClient, CountDownRequest request) throws BusinessException {
        return request(apiClient, request);
    }

    @Override
    public ResultResponse getICP(ICPRequest request) throws BusinessException {
        return request(request);
    }

    @Override
    public ResultResponse getICP(ApiClient apiClient, ICPRequest request) throws BusinessException {
        return request(apiClient, request);
    }

    @Override
    public ResultResponse getWifiGenerate(WifiGenerateRequest request) throws BusinessException {
        return request(request);
    }

    @Override
    public ResultResponse getWifiGenerate(ApiClient apiClient, WifiGenerateRequest request) throws BusinessException {
        return request(apiClient, request);
    }
